...
function SecondProduct() {
  return (
    ...
    <div style={{ textAlign: 'center', padding: '0px', paddingBottom: '0px', width: '80%' }}>
      ...
      <p>Maybe we’d name it our second favorite on the list as it does have a comfortable fit and shows some promising results, but at this price, which was $295, we felt a bit of sticker-shock.</p>

      <p>Why pay more when you can get the same results for less than $200? That’s what we thought!</p><br/>
